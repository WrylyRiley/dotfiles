...
export BULLETTRAIN_CUSTOM_FG=${!arr[5]}
export BULLETTRAIN_CUSTOM_BG=${!arr[0]}
export BULLETTRAIN_DIR_FG=${!arr[5]}
export BULLETTRAIN_DIR_BG=${!arr[1]}
export BULLETTRAIN_GIT_FG=${!arr[5]}
export BULLETTRAIN_GIT_BG=${!arr[2]}
export BULLETTRAIN_NVM_FG=${!arr[5]}
export BULLETTRAIN_NVM_BG=${!arr[3]}
export BULLETTRAIN_TIME_FG=${!arr[5]}
export BULLETTRAIN_TIME_BG=${!arr[4]}
